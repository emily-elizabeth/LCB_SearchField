                                      ...
                                      gpointer user_data)
{
     ...
     *    m_child_window is kept as a root-window child (not reparented under
     *    the engine's stack window), so this produces FocusOut(NotifyNonlinear)
     *    on the engine's window — which GDK honours — allowing the engine's
     *    focused controls to correctly clear their focus styling. */
